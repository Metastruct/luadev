...
local watchlist = rawget(_M, "GetWatchList") and GetWatchList() or {}
function GetWatchList() return watchlist end
...
function RejectCommand(pl, msg)
	...
	if SERVER and luadev_show_access_attempt:GetBool() and not pl.luadevaccessfail then
		...
		Msg "[LuaDev] "
		print(pl, "was rejected luadev access", msg)
	end
