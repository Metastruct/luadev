...
COMMAND('run_client', function(ply, tbl, script, who)
	if ! tbl[1] or ! tbl[2] then
		Print("Syntax: lua_run_client (steamid/userid/accountid/part of name) script")
		return
	end
...
COMMAND('send_cl', function(ply, tbl, cmd, who)
	if ! tbl[1] or ! tbl[2] then
		Print("Syntax: lua_send_cl (steamid/userid/accountid/part of name) \"path\"")
		return
	end
...
COMMAND('watch', function(ply, c, cmd, wholeline)
	...
	if not content or not time then
